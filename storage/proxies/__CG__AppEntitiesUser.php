...
class User extends \App\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\User' . "\0" . 'id', '' . "\0" . 'App\\Entities\\User' . "\0" . 'username', '' . "\0" . 'App\\Entities\\User' . "\0" . 'password', '' . "\0" . 'App\\Entities\\User' . "\0" . 'comments', '' . "\0" . 'App\\Entities\\User' . "\0" . 'salt'];
        }
     ...
     * {@inheritDoc}
     */
    public function setUsername(string $username): \App\Entities\User
    {
     ...
     * {@inheritDoc}
     */
    public function setSalt(string $salt): \App\Entities\User
    {
